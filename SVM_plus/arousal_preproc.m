...
% load features
features = readtable("/Users/jay/Documents/Jay's bits/Uni/Thesis/thesis-pipeline/data/processed/Features/Arousal_averaged_features.csv");

% remove first 5 columns of IDs and DataFrame artefacts
features = features{:,5:end};
%% load ground truths
annotations = readtable("/Users/jay/Documents/Jay's bits/Uni/Thesis/thesis-pipeline/data/processed/Annotations/Arousal/mean_col_annotations.csv");
...
for i = 1:100
    ...
    PI_features = readtable("/Users/jay/Documents/Jay's bits/Uni/Thesis/thesis-pipeline/data/processed/Annotations/Arousal/derived_stats.csv");
    ...
    % consensus level
    y_votes = readtable("/Users/jay/Documents/Jay's bits/Uni/Thesis/thesis-pipeline/data/processed/Annotations/Arousal/A_consensus.csv");
    y_votes = y_votes{:,2};
    ...
    save(strcat("/Users/jay/Documents/Jay's bits/Uni/Thesis/svmplus_matlab-master/MER/Arousal/",folder,'/workspace_vars/',folder,'_',num2str(i)))
